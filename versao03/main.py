...
def rodar_validacao_tfidf(kmer_size, n_clusters, k_vizinhos):
    print(f"Iniciando VALIDAÇÃO (Otimização TF-IDF + Cluster + KNN)...")
    ...
    print(f"Iniciando engenharia de features (k-mers TF-IDF, k={kmer_size})...")
    ...
    print(f"Dataset transformado em uma matriz TF-IDF de {kmer_vectors.shape[0]} genes e {kmer_vectors.shape[1]} features.")
    ...
    print("\n--- Relatório de Desempenho (TF-IDF + Cluster + KNN) ---")
    if not y_true:
